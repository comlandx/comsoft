<cfinclude template="queries/login.cfc">
                ...
                <div class="card rounded-0 border-0 p-5 m-0 w-50">
                    ...
                    <div class="card-body p-0">
                        <form class="form-horizontal" method="post">
                            ...
                            <br><br>
                            <button type="submit" class="btn btn-primary w-100 text-white ff-heading fw-bold shadow">GİRİŞ</button>
                            <br><br>
                            <a href="logsave.cfm" class="btn btn-info w-100 text-white ff-heading fw-bold shadow">KAYIT OL</a> 
                        </form>
                    </div>                        
                </div>
            </div>
